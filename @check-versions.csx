...
{
    // source script file
    SourceFile = ThisSource.RelativeFile("@update-packages.csx"),
...
return await Paved.ProceedAsync(async () =>
{
    ...
    var sourceLines = await settings.SourceFile.ReadAllLinesAsync();
    ...
    if (settings.OverwriteUpdate)
    {
        ...
        await settings.SourceFile.WriteAllLinesAsync(sourceLines);
    }
});
